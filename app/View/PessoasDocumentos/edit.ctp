    ...
    <div class="ym-col3" >
        ...
        <div class="actions ym-cbox">
	        <h4><?php echo __('Ações'); ?></h4>
        		        ...
        		        <?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('PessoasDocumento.id')), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('PessoasDocumento.id'))); ?>        		        <?php echo $this->Html->link(__('Listar Pessoas Documentos'), array('action' => 'index'), array('class'=>'ym-button'));?>        <?php echo __('<h6>Tipo Documentos</h6>'); ?>		<?php echo $this->Html->link(__('Listar Tipo Documentos'), array('controller' => 'tipo_documentos', 'action' => 'index'), array('class'=>'ym-button')); ?> 
