...
<div class="row">
    ...
    <div class="span4" >
        ...
        <li class='nav-header'><?php echo __('Ações'); ?></li>
        		        ...
        		        <li><?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('TipoDado.id')), array('class'=>''), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('TipoDado.id'))); ?></li>
    ...
    <h4 class="ym-fbox-heading"><?php echo __('Editar Tipo Dado'); ?></h4>
