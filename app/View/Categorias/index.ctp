    ...
    <div class="span4">
        <div class="actions">
	        <h3><?php echo __('Ações'); ?></h3>
		        ...
		        <?php echo $this->Html->link(__('Novo Categoria'), array('action' => 'add'), array('class'=>'btn')); ?>        		<?php echo $this->Html->link(__('Listar Classes'), array('controller' => 'classes', 'action' => 'index'), array('class'=>'btn')); ?> 
