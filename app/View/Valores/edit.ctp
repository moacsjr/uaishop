    ...
    <div class="ym-col3" >
        ...
        <div class="actions ym-cbox">
	        <h4><?php echo __('Ações'); ?></h4>
        		        ...
        		        <?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('Valor.id')), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('Valor.id'))); ?>        		        <?php echo $this->Html->link(__('Listar Valores'), array('action' => 'index'), array('class'=>'ym-button'));?>        <?php echo __('<h6>Caracteristicas</h6>'); ?>		<?php echo $this->Html->link(__('Listar Caracteristicas'), array('controller' => 'caracteristicas', 'action' => 'index'), array('class'=>'ym-button')); ?> 
